...
namespace C2W
{
    public partial class Relatorio_Pedidos_Vendas : Form
    {
        public Relatorio_Pedidos_Vendas()
        {
            InitializeComponent();
        }
        ...
        private void Relatorio_Pedidos_Vendas_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Relatorio_Pedidos_Vendas_Load(object sender, EventArgs e)
        {
            Anos.Enabled = false;
        ...
        private void btnEmitir_Click(object sender, EventArgs e)
        {
            ...
            dtPedidoVendas = taPedidoVendas.PedidosDeUmPeriodo(Data1,Data2);
